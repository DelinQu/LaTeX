...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{tabular}{l p{5cm}}
			\textbf{Name} & Qu Delin \\[10pt]
			\textbf{Student No.} & 201808010599 \\[10pt]
			\textbf{Class} & K1805 \\[10pt]
			\textbf{Department} & School of Automation \\[10pt]
			\textbf{Email} & \texttt{example@hnu.edu.cn} \\[10pt]
			\textbf{Date} & \today \\            
		\end{tabular}
		...
		\centering \includegraphics[scale=0.3]{logo_slogan.pdf}
		\vspace{0.5cm}
